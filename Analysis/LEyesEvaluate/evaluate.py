...
from LEyesEvaluate.LEyes_evaluate import do_hourglass_prediction, get_leyes_model, do_leyes_XX
...
def AnalyzePureAndHaar():
    ...
    for dsi in ds:
        ...
        if pxPure > 5 or pxHaar > 5:
            print("[{4}] PURE-> {0}: {1}\n[{5}] HAAR-> {2}: {3}".format(probPure, pxPure, probHaar, pxHaar, ds_count, ds_count))
        ds_count += 1
