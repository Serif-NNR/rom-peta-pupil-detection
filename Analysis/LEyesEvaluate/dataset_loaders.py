...
def process_image(im, mask, feature_value, crop_size, crop_mode, crop_center=None, sfac=1, device=None, notVir = True):
    ...
    if notVir: im = np.expand_dims(im, axis=-1).transpose((2, 0, 1))
