...
def get_leyes_model():
    ...
    #model = torch.load("C:\\Users\\Sheriffnnr\\Desktop\\Fixtare Pupil Detection\\UnetPP_S\\UNetPP-s_x6_FPD_22_l0.019_d0.961_vd0.906.pt")
    #model.eval()
...
def predict_with_leyes(model, im, ox, oy):
    ...
    th = 168 #((np.max(map)-min_value) * 0.5) + min_value + 2
