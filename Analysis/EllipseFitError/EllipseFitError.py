...
ellipseFitErrorDll = CDLL("./EllipseFitError/EllipseFitError.dll")


def EllipseFitErrorUNet(input, target):
    ellipseFitErrorDll = ctypes.CDLL("X:\\Fixein Pupil Detection\\EllipseFitError\\EllipseFitError.dll")
